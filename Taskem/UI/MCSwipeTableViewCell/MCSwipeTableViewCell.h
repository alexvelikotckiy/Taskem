...
- (void)swipeTableViewCell:(MCSwipeTableViewCell *)cell didSwipeWithGesture:(UIPanGestureRecognizer*)gesture;

// Custom
- (BOOL)swipeTableViewCellShouldSwipe:(MCSwipeTableViewCell *)cell;

- (BOOL)swipeTableViewCellShouldExecuteCompletion:(MCSwipeTableViewCell *)cell;
