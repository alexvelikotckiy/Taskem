final class PullToDismissManager: NSObject, UIScrollViewDelegate {
    ...
    private weak var presentationController: DrawerPresentationController?
    ...
    init(delegate: UIScrollViewDelegate?, presentationController: DrawerPresentationController) {
