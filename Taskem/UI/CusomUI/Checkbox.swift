...
public class Checkbox: UIControl {
    ...
    private func squareBorder(rect: CGRect) {
        ...
        rectanglePath.lineWidth = border
    ...
    private func circleBorder(rect: CGRect) {
        let adjustedRect = CGRect(x: border/2,
                                  y: border/2,
                                  width: rect.width-border,
                                  height: rect.height-border)
