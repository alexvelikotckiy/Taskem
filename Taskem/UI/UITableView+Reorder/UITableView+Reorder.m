	...
	if( self.toIndexPathForRowBeingMoved ) {
		...
		[UIView animateWithDuration: 0.25 animations: ^{
			...
			[UIView animateWithDuration: 0.1 animations:^{
                ...
                NSIndexPath *initialIndexPath = [NSIndexPath indexPathForRow: self.fromIndexPathOfRowBeingMoved.row inSection: self.fromIndexPathOfRowBeingMoved.section];
                NSIndexPath *finalIndexPath = [NSIndexPath indexPathForRow: self.toIndexPathForRowBeingMoved.row inSection: self.toIndexPathForRowBeingMoved.section];
                ...
                if( [self.dataSource respondsToSelector: @selector(tableView:moveRowAtIndexPath:toIndexPath:)] ) {
                    [self.dataSource tableView: self moveRowAtIndexPath: initialIndexPath toIndexPath: finalIndexPath];
                }
			}];
        }];
	}
